// Generated on 2014-11-17 using generator-bootstrap-less 3.2.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    useminPrepare: {
      html: [ '<%= yeoman.app %>/includes/scripts.html',
              '<%= yeoman.app %>/includes/html_header.html'],
      options: {
        dest: '<%= yeoman.dist %>'
      }
    },
    ...
    includes: {
          build: {
              ...
              options: {
                  flatten: true,
                  includePath: '<%= yeoman.dist %>/includes',
                  silent: false,
                  //debug: true,
                  banner: ''
              }
